...
const summarize = (patientData, manualDailyData, manualPrefectureData, recoveries, prefectureNames, regions, lastUpdated) => {
  ...
  let prefectureSummary = generatePrefectureSummary(patients, manualPrefectureData, recoveryByPrefecture, prefectureNames)
...
const generatePrefectureSummary = (patients, manualPrefectureData, recoveryByPrefecture, prefectureNames) => {
